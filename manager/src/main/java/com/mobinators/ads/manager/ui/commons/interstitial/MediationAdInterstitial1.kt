...
object MediationAdInterstitial1 {
...
//        initSelectedAd()
                    ...
                    this.admobInterstitialAD!!.fullScreenContentCallback =
                        object : FullScreenContentCallback() {
                            override fun onAdFailedToShowFullScreenContent(error: AdError) {
                                ...
                                logD("Show Admob Interstitial Ads Failed")
                            ...
                            override fun onAdDismissedFullScreenContent() {
                                ...
                                logD("Show Admob Interstitial Ads Dismiss")
    ...
    private fun initAdMobInterstitialAd() {
        try {
            ...
            logD("Load Admob : ${AdsConstants.loadAdmobInters} : ${  admobInterstitialAD!!.responseInfo.responseId}")
